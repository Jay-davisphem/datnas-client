    ...
    <div className="p-6 md:px-16 lg:px-32 bg-white pt-8 pb-16">
      <div className="text-black">
        <div className="md:justify-end flex flex-col md:flex-row gap-4 mb-4 md:mb-8">
          <Link href='/course/new' className="bg-[#004ce8] text-white drop-shadow-md hover:opacity-80 rounded-md w-full justify-center flex-wrap md:w-1/5 p-4 text-base flex items-center">Create Course</Link>
