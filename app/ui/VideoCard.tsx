...
const StarRating = dynamic(() => import("@/app/ui/body/home/courses/StarRating"), { ssr: false });
    ...
    >
      ...
      <div className="px-2 mt-4 ">
        <div className="flex justify-start">
          <p className="text-[10px]"><span className="text-gray-500">Course Title: </span>{courseTitle}</p>
        </div>
      </div>
