      ...
      <div className="gap-10 flex flex-col md:flex-row p-6 md:p-16 lg:p-32 pb-40 justify-between">
        ...
        <div className="w-full md:w-11/20 flex flex-col rounded bg-white md:px-7 gap-4 md:py-12 justify-start">
          <div className="self-start flex flex-col gap-4 md:gap-8 p-0">
            ...
            <p className={`${openSans.className} md:text-base text-xs`}>
              Lorem ipsum dolor sit amet consectetur. Lacus in ultrices
              vestibulum netus molestie non auctor justo. Sed commodo ut ut
              vehicula malesuada. Sapien gravida pharetra
            </p>
          </div>
          <div className="flex flex-col gap-4 md:gap-6">
            {inputs.map((inp, index) => (
              <CustomInput key={index} {...inp} />
            ))}
            <div className="flex">
