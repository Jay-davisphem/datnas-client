...
export default function AboutUs1() {
  return (
    <div className="tr-hero-image bg-cover  bg-no-repeat bg-center w-full relative z-1 p-6 pt-25 md:p-16 lg:p-32 pb-40 lg:pb-64 ">
      ...
      <div className="text-white relative bg-transparent flex flex-col items-center h-full text-2xl z-3 gap-8 brightness-125 drop-shadow-lg">
        <h1 className='text-3xl z-67 md:text-6xl font-black'>About Us</h1>
        <p className='text-base z-67 md:px-32 text-center lg:px-70'>
