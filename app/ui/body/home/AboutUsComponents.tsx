    ...
    <div className="relative w-full flex flex-col items-center text-center p-6 md:p-16 lg:p-32 pb-40 lg:pb-64">
      ...
      <div className="text-white flex flex-col items-center gap-8 max-w-4xl brightness-125 drop-shadow-lg">
        ...
        <ScaleUpParagraph className="text-base md:px-16 lg:px-20">
          Unlock limitless learning with our educational platform. Explore,
          discover, and achieve your goals with personalized learning
  ...
  return (
    <div className="mb-2 bg-white w-full flex flex-col-reverse lg:flex-row justify-between items-center px-6 md:px-16 lg:px-32 py-16 md:py-24 gap-16">
      ...
      <div className="w-full md:w-2/5 flex flex-col gap-2 md:gap-4 lg:gap-6">
        <h2 className="font-bold text-2xl md:text-3xl lg:text-4xl text-center md:text-left">
          Know more about us
        </h2>
        <ScaleUpParagraph
          className={`${openSans.className} text-justify md:text-left text-sm lg:text-base leading-8`}
        >
          Lorem ipsum dolor sit amet consectetur. Bibendum arcu turpis morbi
          arcu morbi ut varius. Mi amet enim ac placerat. Nullam magna dis
          nascetur cras tincidunt gravida nisl. Amet adipiscing sed sagittis
          eget lectus consectetur. Eget arcu nulla ac cras a lectus maecenas.
          Condimentum orci et aenean feugiat eget dignissim purus porttitor.
          Pellentesque cras dolor egestas malesuada. Praesent a duis et aliquet
          sollicitudin fringilla nam molestie fusce. Nunc quam enim laoreet in
          pellentesque accumsan. Imperdiet convallis mattis nisl at at sagittis.
          Fermentum sagittis magna nisl sed. Tincidunt et elementum amet
          suspendisse neque neque gravida quam.
        </ScaleUpParagraph>
        <Link
          href="/about-us"
          className="hidden md:block hover:opaque-80 active:opaque-80"
        >
          <Button
            className="text-sm border md:px-8 lg:px-16 lg:text-xl px-6 md:py-4"
            variant="primary"
          >
            Learn More
          </Button>
...
export function AboutUs3() {
  const missions: IMission[] = [
    {
      src: "/holistic.jpeg",
      title: "Holistic Approach to teaching",
      content:
        "Beyond academic excellence, we prioritize the holistic development of our students. We foster a supportive learning environment where students not only gain knowledge but also develop essential qualities such as empathy, resilience, and professionalism—qualities that are integral to becoming exemplary healthcare professionals.",
    },
    {
      src: "/comp-curri.jpeg",
      title: "Comprehensive Curriculum",
      content:
        " Our platform offers a comprehensive curriculum designed to cover all aspects of nursing education. From foundational concepts to advanced clinical skills, we provide resources and tutoring across various specialties to ensure a well-rounded education for our students.",
    },
    {
      src: "/tailored.jpeg",
      title: "Tailored Learning Experience",
      content:
        "At DATNAS, we believe in customizing our tutoring services to meet the unique needs of each nursing student. Through personalized learning plans and one-on-one guidance, we ensure that every student receives the support they need to succeed.",
    },
  ];
  return (
    <div className="mb-2 bg-white w-full flex flex-col items-center px-6 md:px-16 lg:px-32 py-16 md:py-24 gap-16">
      <div className="flex flex-col w-full md:w-3/5 text-center justify-center items-center">
        ...
        <p className={`${openSans.className} text-base w-full mt-4 mb-2`}>
          Our mission is to provide globally accessible, interactive, and
          high-quality tutoring services for nursing and allied health students,
          fostering academic excellence, professional growth, and positive
          impact in healthcare.
        </p>
        <Image
          src="/unstraightline.svg"
    ...
    <div className="mb-2 bg-white w-full flex flex-col lg:flex-row justify-between items-center px-6 md:px-16 lg:px-32 py-16 md:py-24 gap-16">
      <div className="w-full md:w-2/5 flex flex-col gap-2 md:gap-4 lg:gap-6">
        ...
        >
          ...
          transformative online tutoring services, empowering nursing and allied
          health students worldwide to reach their fullest potential and become
          compassionate, competent, and impactful healthcare professionals.{" "}
        </ScaleUpParagraph>
        <Link
          href="/about-us"
          className="hidden md:block hover:opaque-80 active:opaque-80"
  ...
  return (
    <div className="mb-2 bg-white w-full flex flex-col items-center px-6 md:px-16 lg:px-32 py-16 md:py-24 gap-16">
      <div className="flex flex-col w-full md:w-3/5 text-center justify-center items-center">
        ...
        <p className={`${openSans.className} text-base w-full mt-4 mb-2`}>
          Access to our easy to understand course videos with well detailed
          explanation, image representation and illustrations
        </p>
        <Image
          src="/unstraightline.svg"
          alt="underline our mission"
